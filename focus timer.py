...
class TaskApp:
    ...
    def create_widgets(self):
        ...
        btn_pomodoro = tk.Button(sidebar_frame, text="Focus Timer", width=20, highlightbackground="lightgrey", command=self.start_focus_timer)
        ...
        self.frames = {
            ...
            "focus_timer": tk.Frame(self.main_frame)
        }
    ...
    def start_focus_timer(self):
        self.show_frame("focus_timer")
        self.clear_frame(self.frames["focus_timer"])
        ...
        self.time_label = tk.Label(self.frames["focus_timer"], text="25:00", font=("Helvetica", 48))
        self.time_label.pack(pady=20)

        self.start_button = tk.Button(self.frames["focus_timer"], text="Start", command=self.toggle_timer)
        self.start_button.pack(pady=10)

        self.reset_button = tk.Button(self.frames["focus_timer"], text="Reset", command=self.reset_timer)
    ...
    def notify_user(self):
        if self.is_work_time:
            ...
            notification.notify(
                title="Study Time",
                message="Time to get back to study!",
                timeout=10
            )
